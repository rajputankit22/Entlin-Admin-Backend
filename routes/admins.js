...
router.get("/fetchEmployee/:employeeId", validator.employeeIdValidator, auth.loginAuth, auth.adminAccessAuth, utility.admins.fetchEmployee); // Api fetch one employee.
router.get("/removeEmployee/:employeeId", validator.employeeIdValidator, auth.loginAuth, auth.adminAccessAuth, utility.admins.removeEmployee); // Api to remove employee.
