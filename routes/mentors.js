...
router.post("/updateProfile/:mentorId", validator.mentorIdValidator, validator.updateProfileValidator, auth.loginAuth, auth.adminAccessAuth, utility.mentors.updateProfile); // Api to update mentor profile.
