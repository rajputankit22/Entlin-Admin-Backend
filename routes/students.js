...
router.get("/fetchStudent:/sudentId", auth.loginAuth, utility.students.fetchStudent); // Api to fetch single student.
router.get("/fetchAllStudents", auth.loginAuth, utility.students.fetchAllStudents); // Api to fetch all student.
router.get("/removeStudent:/sudentId", auth.loginAuth, utility.students.removeStudent); // Api to remove student.
